...
# async def stream_camera(request: Request, camera_id: int, current_user: UserSchema = Depends(get_current_user), token: str = Depends(get_token)):
    ...
    """
    token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI4ZWY5ZjJhZi1hMWMxLTQwMDktOTMwNi0xMTgxNzRiM2U5NmYiLCJleHAiOjE3MzU3OTc2MDl9.Sp8haTNWzu1bSpIOPPqe8q1un1i8HO3ac65zbte_PsI"
